...
public class Main {
    public static void main(String[] args) {
        MenuePlaner mp = new MenuePlaner(getZutatenListe());
        mp.erstelleSpeiseplan();
        System.out.println(mp.getMenueFuerWochentag("Donnerstag"));
        System.out.println(mp.getMenueFuerWochentag("Mittwoch"));
    }
